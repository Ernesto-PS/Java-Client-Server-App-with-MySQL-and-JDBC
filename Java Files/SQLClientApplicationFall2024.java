...
public class SQLClientApplicationFall2024 extends JFrame
{
    ...
    private JLabel connectionDetailsLabel, dbURLPropertiesLabel, userPropertiesLabel, usernameLabel, 
                   passwordLabel, enterSQLCommandLabel, sqlExecutionResultLabel; 
    private static JLabel connectionEstablishedLabel; 

    // Declare reference variables combo boxes
    private JComboBox<String> ulrPropertiesCombo, userPropertiesCombo; 
    ...
    public SQLClientApplicationFall2024()
    {
        ...
        // Defines combo boxes
        ulrPropertiesCombo = new JComboBox<>(new String[]{"project3.properties", "bikedb.properties"});
        userPropertiesCombo = new JComboBox<>(new String[]{"root.properties", "client1.properties", "client2.properties"});

        // Positioning for combo boxes
        ulrPropertiesCombo.setBounds(175, 50, 245, 30);
        userPropertiesCombo.setBounds(175, 90, 245, 30);
        ...
        discFromDB.setForeground(Color.BLACK);
        ...
        pane.add(ulrPropertiesCombo);
        pane.add(userPropertiesCombo);
        ...
        // Styles buttons' font color
        clearSQLCommandBtn.setForeground(Color.BLACK);
        executeSQLCommandBtn.setForeground(Color.BLACK);

        // Styles buttons' background color and its borders
        clearSQLCommandBtn.setBackground(Color.YELLOW);
    ...
    private class ConnectToDBHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            try 
            {
                ...
                if (usernameInput.equals("") || passwordInput.equals(""))
                {
                    JOptionPane.showMessageDialog(null, "No username or password detected", 
                                    "SQLClientApplicationFall2024 - CREDENTIALS ERROR", JOptionPane.ERROR_MESSAGE);
                }
                else 
                {
                    // Declares and stores properties selected by user
                    String urlPropertiesSelected = (String) ulrPropertiesCombo.getSelectedItem();
                    String userPropertiesSelected = (String) userPropertiesCombo.getSelectedItem();
                    ...
                    try 
                    {
                        ...
                        else
                        {
                            JOptionPane.showMessageDialog(null,
                                    "Username or Password incorrect", "SQLClientApplicationFall2024 - CREDENTIALS ERROR", JOptionPane.ERROR_MESSAGE);
                    ...
                    {
                        JOptionPane.showMessageDialog(null,
                                    sqlException.getMessage(), "SQLClientApplicationFall2024 - DATABASE ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                    catch (IOException io) 
                    {
                        JOptionPane.showMessageDialog(null,
                                    io.getMessage(), "SQLClientApplicationFall2024 - PROPERTY FILE ERROR", JOptionPane.ERROR_MESSAGE);
                    }
            ...
            {
                JOptionPane.showMessageDialog(null, ex.getMessage(), "SQLClientApplicationFall2024 - ERROR", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private class DiscFromDBHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, ex.getMessage(), "SQLClientApplicationFall2024 - DATABASE ERROR", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private class ExecuteSQLCommandHandler implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                JOptionPane.showMessageDialog(null,
                        "Not Connected to Database", "SQLClientApplicationFall2024 - CONNECTION ERROR", JOptionPane.ERROR_MESSAGE);
            }
            else
            { 
                ...
                try 
                {
                    ...
                    else 
                    {
                        ...
                        if (rowsAffected != 0) {
                            JOptionPane.showMessageDialog(null, "Successful Update... " + rowsAffected + " row(s) updated.", "SQLClientApplicationFall2024 - UPDATE SUCCESS", JOptionPane.INFORMATION_MESSAGE);
                        }
                        else if (rowsAffected == 0)
                        {
                            JOptionPane.showMessageDialog(null, rowsAffected + " rows were updated.", "SQLClientApplicationFall2024 - UPDATE NOTICE", JOptionPane.INFORMATION_MESSAGE);
                        }
                    }
                } 
                catch (SQLException ex) 
    ...
    {
        JFrame SQLCLientApplication = new SQLClientApplicationFall2024(); // Create the frame object
        SQLCLientApplication.setTitle("SQL Client Application - (EPS - CNT 4714 - FALL 2024 - PROJECT 3)"); // Sets the title of the frame
        SQLCLientApplication.setSize(900,700); // Sets the frame size
        SQLCLientApplication.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Closes the application if the user clicks upon the "X" icon.
        SQLCLientApplication.setVisible(true); // Display the frame
    }
}
